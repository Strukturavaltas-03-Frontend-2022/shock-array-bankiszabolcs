 ...
 */
 ...
 const sortInternationalUsersByCity = function(users=[{name: 'Ákos', age: 44, city: 'Bp'}]){
...
const sortInternationalUsersByAgeDesc = function(users=[{name: 'Ákos', age: 44, city: 'Bp'}]){
